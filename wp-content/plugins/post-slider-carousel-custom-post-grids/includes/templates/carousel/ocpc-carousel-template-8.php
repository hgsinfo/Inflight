        ...
        while($ocpc_postquery->have_posts() ) {
            ...
            ?>
                <div class="ocpc-topbox">
                    <div class="ocpc_tmplt8_crsol_main">
                        <div class="ocpc_tmplt8_crsol_img_div">
                            <div class="ocpc_tmplt8_crsol_img">
                                <a target="_self" href="<?php echo $post_link; ?>">
                                    <img alt="" src="<?php echo $ocpc_post_image_url; ?>">
                                </a>
                            </div>
                        </div>
                        <div class="ocpc_tmplt8_crsol_cont_main">
                            <?php
                            if($ocpc_posttitle == 'yes') {
                            ?>
                                <div class="ocpc_tmplt8_crsol_cont_title">
                            ...
                            ?>
                                <div class="ocpc_tmplt8_crsol_cont_date">
                            ...
                            ?>
                                <div class="ocpc_tmplt8_crsol_cont_cats">
                            ...
                            ?>
                                <div class="ocpc_tmplt8_crsol_cont_author">
                            ...
                            ?>
                            <div class="ocpc_tmplt8_crsol_cont_dec">
                                <?php echo $post_desc; ?>
                            </div>
                            <?php
                            }
