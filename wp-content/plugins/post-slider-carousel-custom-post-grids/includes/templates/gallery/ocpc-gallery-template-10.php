...
if($ocpc_postquery->have_posts() ) {
    ...
    ?>        
        <div class="ocpc-topbox" style="width:<?php echo $width?>%; padding:<?php echo $ocpc_gl_space_img?>px;">
            ...
            <div class="ocpc_tmplt10_glry_main">
                <div class="ocpc_tmplt10_glry_img_div">
                    <div class="ocpc_tmplt10_glry_img">
                        <a target="_self" href="<?php echo $post_link; ?>">
                            <img alt="" src="<?php echo $ocpc_post_image_url; ?>">
                        </a>
                    </div>
                </div>
                <div class="ocpc_tmplt10_glry_cont_main">
                    <?php
                    if($ocpc_posttitle == 'yes') {
                    ?>
                        <div class="ocpc_tmplt10_glry_cont_title">
                    ...
                    ?>
                        <div class="ocpc_tmplt10_glry_cont_date">
                    ...
                    ?>
                        <div class="ocpc_tmplt10_glry_cont_cats">
                    ...
                    ?>
                        <div class="ocpc_tmplt10_glry_cont_author">
                    ...
                    ?>
                    <div class="ocpc_tmplt10_glry_cont_dec">
                        <?php echo $post_desc; ?>
                    </div>
                    <?php
                    }
