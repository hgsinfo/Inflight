				...
				switch ( $action ) {
					...
					case 'send_giftcard':
						if ( ! $giftcard->has_expired() && $giftcard->is_active() ) {
							...
							WC_GC_Admin_Notices::add_notice( __( 'Action failed. Deactivated and expired gift cards cannot be e-mailed to their original recipients.', 'woocommerce-gift-cards' ), 'error', true );
						}
						break;
