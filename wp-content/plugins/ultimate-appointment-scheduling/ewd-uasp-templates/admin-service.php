<div class='ewd-uasp-container ewd-uasp-service'>

	<div class='ewd-uasp-field'>

		<div class='ewd-uasp-input-label'>
			<?php _e( 'Location', 'ultimate-appointment-scheduling' ); ?>
		</div>
	...
	<div class='ewd-uasp-field'>
		...
		<div class='ewd-uasp-input-label'>
			<?php _e( 'Service', 'ultimate-appointment-scheduling' ); ?>
		</div>
	...
	<div class='ewd-uasp-field'>
		...
		<div class='ewd-uasp-input-label'>
			<?php _e( 'Service Provider', 'ultimate-appointment-scheduling' ); ?>
		</div>
